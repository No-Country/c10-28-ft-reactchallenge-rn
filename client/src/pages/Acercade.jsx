    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text style={styles.description}>
          Con Cambialo, podrás publicar tus objetos y buscar lo que necesitas de
          ...
          Con Cambialo, podrás darles una segunda oportunidad y obtener nuevos
          objetos que necesites. Regístrate ahora y únete a nuestra comunidad de
          intercambio de objetos. ¡Cambialo, la plataforma que conecta a personas
          con objetos!
        </Text>
      </View>
    </ScrollView>
